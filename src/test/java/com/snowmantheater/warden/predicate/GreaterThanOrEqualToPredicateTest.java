...
class GreaterThanOrEqualToPredicateTest {
    ...
    public void testing_test_where_Type_is_boolean() {
        ...
        predicate = new AssertGreaterThanOrEqualTo(true);
        assertTrue(predicate.test(BOOL_TRUE));
        assertFalse(predicate.test(BOOL_FALSE));

        predicate = new AssertGreaterThanOrEqualTo(false);
        assertTrue(predicate.test(BOOL_TRUE));
        assertTrue(predicate.test(BOOL_FALSE));

        predicate = new AssertGreaterThanOrEqualTo(0);
        assertFalse(predicate.test(BOOL_TRUE));
        assertFalse(predicate.test(BOOL_FALSE));

        predicate = new AssertGreaterThanOrEqualTo(1);
        assertFalse(predicate.test(BOOL_TRUE));
        assertFalse(predicate.test(BOOL_FALSE));
    }
    ...
    public void testing_test_where_Type_is_char() {
        ...
        predicate = new AssertGreaterThanOrEqualTo('M');
    ...
    public void testing_test_where_Type_is_double() {
        ...
        predicate = new AssertGreaterThanOrEqualTo(0D);
    ...
    public void testing_test_where_Type_is_float() {
        ...
        predicate = new AssertGreaterThanOrEqualTo(0F);
    ...
    public void testing_test_where_Type_is_long() {
        ...
        predicate = new AssertGreaterThanOrEqualTo(0L);
    ...
    public void testing_test_where_Type_is_short() {
        ...
        predicate = new AssertGreaterThanOrEqualTo((short)0);
    ...
    public void calling_new_null_throws_Exception() {
        assertThrows(IllegalArgumentException.class, () -> new AssertGreaterThanOrEqualTo(null) );
    }

    @Test
    @DisplayName("Testing test(Number t)")
    public void testing_test_where_Type_is_Number() {
        Predicate<Object> predicate = new AssertGreaterThanOrEqualTo(0);
    ...
    public void testing_test_where_Type_is_Object() {
        Predicate<Object> predicate = new AssertGreaterThanOrEqualTo(OBJECT_VALUE);
    ...
    public void testing_test_where_Type_is_String() {
        Predicate<Object> predicate = new AssertGreaterThanOrEqualTo("ABC");
    ...
    public void testing_test_where_Type_is_List() {
        Predicate<Object> predicate = new AssertGreaterThanOrEqualTo(Collections.emptyList());
    ...
    public void testing_test_where_Type_is_Map() {
        Predicate<Object> predicate = new AssertGreaterThanOrEqualTo(Collections.emptyMap());
    ...
    public void testing_test_where_Type_is_Set() {
        Predicate<Object> predicate = new AssertGreaterThanOrEqualTo(Collections.emptySet());
    ...
    public void testing_test_where_Type_is_ObjectArr() {
        Predicate<Object> predicate = new AssertGreaterThanOrEqualTo(new Object[] { });
    ...
    public void testing_test_where_Type_is_booleanArr() {
        Predicate<Object> predicate = new AssertGreaterThanOrEqualTo(new boolean[] { });
    ...
    public void testing_test_where_Type_is_byteArr() {
        Predicate<Object> predicate = new AssertGreaterThanOrEqualTo(new byte[] { });
    ...
    public void testing_test_where_Type_is_charArr() {
        Predicate<Object> predicate = new AssertGreaterThanOrEqualTo(new char[] { });
    ...
    public void testing_test_where_Type_is_doubleArr() {
        Predicate<Object> predicate = new AssertGreaterThanOrEqualTo(new double[] { });
    ...
    public void testing_test_where_Type_is_floatArr() {
        Predicate<Object> predicate = new AssertGreaterThanOrEqualTo(new float[] { });
    ...
    public void testing_test_where_Type_is_intArr() {
        Predicate<Object> predicate = new AssertGreaterThanOrEqualTo(new int[] { });
    ...
    public void testing_test_where_Type_is_longArr() {
        Predicate<Object> predicate = new AssertGreaterThanOrEqualTo(new long[] { });
    ...
    public void testing_test_where_Type_is_shortArr() {
        Predicate<Object> predicate = new AssertGreaterThanOrEqualTo(new short[] { });
    ...
    public void calling_negate_returns_instanceof_AssertLessThan() {
        ...
        assertEquals(AssertLessThan.class, negated.getClass());
    }
}
