...
class GreaterThanPredicateTest {
    ...
    public void testing_test_where_Type_is_boolean() {
        ...
        predicate = new AssertGreaterThan(true);
        assertFalse(predicate.test(BOOL_TRUE));
        assertFalse(predicate.test(BOOL_FALSE));

        predicate = new AssertGreaterThan(false);
        assertTrue(predicate.test(BOOL_TRUE));
        assertFalse(predicate.test(BOOL_FALSE));

        predicate = new AssertGreaterThan(0);
        assertFalse(predicate.test(BOOL_TRUE));
        assertFalse(predicate.test(BOOL_FALSE));

        predicate = new AssertGreaterThan(1);
        assertFalse(predicate.test(BOOL_TRUE));
        assertFalse(predicate.test(BOOL_FALSE));
    }
    ...
    public void testing_test_where_Type_is_char() {
        ...
        predicate = new AssertGreaterThan('M');
    ...
    public void testing_test_where_Type_is_double() {
        ...
        predicate = new AssertGreaterThan(0D);
    ...
    public void testing_test_where_Type_is_float() {
        ...
        predicate = new AssertGreaterThan(0F);
    ...
    public void testing_test_where_Type_is_int() {
        ...
        predicate = new AssertGreaterThan((char)0); assertFalse(predicate.test(INT_NEG3));
        assertFalse(predicate.test(INT_ZERO));
    ...
    public void testing_test_where_Type_is_long() {
        ...
        predicate = new AssertGreaterThan(0L);
    ...
    public void testing_test_where_Type_is_short() {
        ...
        predicate = new AssertGreaterThan((short)0);
    ...
    public void calling_new_null_throws_Exception() {
        assertThrows(IllegalArgumentException.class, () -> new AssertGreaterThan(null) );
    }

    @Test
    @DisplayName("Testing test(Number t)")
    public void testing_test_where_Type_is_Number() {
        Predicate<Object> predicate = new AssertGreaterThan(0);
    ...
    public void testing_test_where_Type_is_Object() {
        Predicate<Object> predicate = new AssertGreaterThan(OBJECT_VALUE);
    ...
    public void testing_test_where_Type_is_String() {
        Predicate<Object> predicate = new AssertGreaterThan("ABC");
    ...
    public void testing_test_where_Type_is_List() {
        Predicate<Object> predicate = new AssertGreaterThan(Collections.emptyList());
    ...
    public void testing_test_where_Type_is_Map() {
        Predicate<Object> predicate = new AssertGreaterThan(Collections.emptyMap());
    ...
    public void testing_test_where_Type_is_Set() {
        Predicate<Object> predicate = new AssertGreaterThan(Collections.emptySet());
    ...
    public void testing_test_where_Type_is_ObjectArr() {
        Predicate<Object> predicate = new AssertGreaterThan(new Object[] { });
    ...
    public void testing_test_where_Type_is_booleanArr() {
        Predicate<Object> predicate = new AssertGreaterThan(new boolean[] { });
    ...
    public void testing_test_where_Type_is_byteArr() {
        Predicate<Object> predicate = new AssertGreaterThan(new byte[] { });
    ...
    public void testing_test_where_Type_is_charArr() {
        Predicate<Object> predicate = new AssertGreaterThan(new char[] { });
    ...
    public void testing_test_where_Type_is_doubleArr() {
        Predicate<Object> predicate = new AssertGreaterThan(new double[] { });
    ...
    public void testing_test_where_Type_is_floatArr() {
        Predicate<Object> predicate = new AssertGreaterThan(new float[] { });
    ...
    public void testing_test_where_Type_is_intArr() {
        Predicate<Object> predicate = new AssertGreaterThan(new int[] { });
    ...
    public void testing_test_where_Type_is_longArr() {
        Predicate<Object> predicate = new AssertGreaterThan(new long[] { });
    ...
    public void testing_test_where_Type_is_shortArr() {
        Predicate<Object> predicate = new AssertGreaterThan(new short[] { });
    ...
    public void calling_negate_returns_instanceof_AssertLessTHanOrEqualTo() {
        ...
        assertEquals(AssertLessThanOrEqualTo.class, negated.getClass());
    }
}
