...
class LessThanOrEqualToPredicateTest {
    ...
    public void testing_test_where_Type_is_boolean() {
        ...
        predicate = new AssertLessThanOrEqualTo(true);
        assertTrue(predicate.test(BOOL_TRUE));
        assertTrue(predicate.test(BOOL_FALSE));

        predicate = new AssertLessThanOrEqualTo(false);
        assertFalse(predicate.test(BOOL_TRUE));
        assertTrue(predicate.test(BOOL_FALSE));

        predicate = new AssertLessThanOrEqualTo(0);
        assertFalse(predicate.test(BOOL_TRUE));
        assertFalse(predicate.test(BOOL_FALSE));

        predicate = new AssertLessThanOrEqualTo(1);
        assertFalse(predicate.test(BOOL_TRUE));
        assertFalse(predicate.test(BOOL_FALSE));
    }

    @Test
    @DisplayName("Testing AssertLessEqual(x).test(byte t)")
    public void testing_test_where_Type_is_byte() {
        Predicate<Object> predicate;

        predicate = new AssertLessThanOrEqualTo((byte)0);
        assertTrue(predicate.test(BYTE_NEG3));
        assertTrue(predicate.test(BYTE_ZERO));
        assertFalse(predicate.test(BYTE_POS3));

        predicate = new AssertLessThanOrEqualTo((char)0);
    ...
    @Test
    @DisplayName("Testing AssertLessEqual(x).test(char t)")
    public void testing_test_where_Type_is_char() {
        Predicate<Object> predicate;

        predicate = new AssertLessThanOrEqualTo('M');
        assertTrue(predicate.test(CHAR_A));
        assertTrue(predicate.test(CHAR_M));
    ...
    @Test
    @DisplayName("Testing AssertLessEqual(x).test(double t)")
    public void testing_test_where_Type_is_double() {
        Predicate<Object> predicate;

        predicate = new AssertLessThanOrEqualTo(0D);
    ...
    @Test
    @DisplayName("Testing AssertLessEqual(x).test(float t)")
    public void testing_test_where_Type_is_float() {
        Predicate<Object> predicate;

        predicate = new AssertLessThanOrEqualTo(0F);
    ...
    @Test
    @DisplayName("Testing AssertLessEqual(x).test(int t)")
    ...
    @Test
    @DisplayName("Testing AssertLessEqual(x).test(long t)")
    public void testing_test_where_Type_is_long() {
        Predicate<Object> predicate;

        predicate = new AssertLessThanOrEqualTo(0L);
    ...
    @Test
    @DisplayName("Testing AssertLessEqual(x).test(short t)")
    public void testing_test_where_Type_is_short() {
        Predicate<Object> predicate;

        predicate = new AssertLessThanOrEqualTo((short)0);
    ...
    public void calling_new_null_throws_Exception() {
        assertThrows(IllegalArgumentException.class, () -> new AssertLessThanOrEqualTo(null) );
    }

    @Test
    @DisplayName("Testing test(Number t)")
    public void testing_test_where_Type_is_Number() {
        Predicate<Object> predicate = new AssertLessThanOrEqualTo(0);
    ...
    public void testing_test_where_Type_is_Object() {
        Predicate<Object> predicate = new AssertLessThanOrEqualTo(OBJECT_VALUE);
    ...
    public void testing_test_where_Type_is_String() {
        Predicate<Object> predicate = new AssertLessThanOrEqualTo("XYZ");
    ...
    public void testing_test_where_Type_is_List() {
        Predicate<Object> predicate = new AssertLessThanOrEqualTo(Collections.emptyList());
    ...
    public void testing_test_where_Type_is_Map() {
        Predicate<Object> predicate = new AssertLessThanOrEqualTo(Collections.emptyMap());
    ...
    public void testing_test_where_Type_is_Set() {
        Predicate<Object> predicate = new AssertLessThanOrEqualTo(Collections.emptySet());
    ...
    public void testing_test_where_Type_is_ObjectArr() {
        Predicate<Object> predicate = new AssertLessThanOrEqualTo(new Object[] { });
    ...
    public void testing_test_where_Type_is_booleanArr() {
        Predicate<Object> predicate = new AssertLessThanOrEqualTo(new boolean[] { });
    ...
    public void testing_test_where_Type_is_byteArr() {
        Predicate<Object> predicate = new AssertLessThanOrEqualTo(new byte[] { });
    ...
    public void testing_test_where_Type_is_charArr() {
        Predicate<Object> predicate = new AssertLessThanOrEqualTo(new char[] { });
    ...
    public void testing_test_where_Type_is_doubleArr() {
        Predicate<Object> predicate = new AssertLessThanOrEqualTo(new double[] { });
    ...
    public void testing_test_where_Type_is_floatArr() {
        Predicate<Object> predicate = new AssertLessThanOrEqualTo(new float[] { });
    ...
    public void testing_test_where_Type_is_intArr() {
        Predicate<Object> predicate = new AssertLessThanOrEqualTo(new int[] { });
    ...
    public void testing_test_where_Type_is_longArr() {
        Predicate<Object> predicate = new AssertLessThanOrEqualTo(new long[] { });
    ...
    public void testing_test_where_Type_is_shortArr() {
        Predicate<Object> predicate = new AssertLessThanOrEqualTo(new short[] { });
    ...
    @Test
    @DisplayName("Calling negate() returns instanceof AssertGreaterThan")
    public void calling_negate_returns_instanceof_AssertGreaterThan() {
        Predicate<Object> predicate = new AssertLessThanOrEqualTo(0);
        Predicate<Object> negated = predicate.negate();
        assertEquals(AssertGreaterThan.class, negated.getClass());
    }
}
