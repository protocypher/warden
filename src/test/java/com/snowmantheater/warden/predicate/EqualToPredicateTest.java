...
class EqualToPredicateTest {
    ...
    public void testing_test_where_Type_is_double() {
        ...
        predicate = new AssertEqualTo(3.3D);
    ...
    public void testing_test_where_Type_is_float() {
        ...
        predicate = new AssertEqualTo(3.3F);
    ...
    public void testing_test_where_Type_is_long() {
        ...
        predicate = new AssertEqualTo(3L);
    ...
    public void testing_test_where_Type_is_short() {
        ...
        predicate = new AssertEqualTo((short)3);
    ...
    public void testing_test_where_Type_is_Number() {
        ...
        predicate = new AssertEqualTo(null);
    ...
    public void testing_test_where_Type_is_Object() {
        ...
        predicate = new AssertEqualTo(OBJECT_VALUE);
    ...
    public void testing_test_where_Type_is_String() {
        ...
        predicate = new AssertEqualTo("ABC");
    ...
    public void testing_test_where_Type_is_List() {
        Predicate<Object> predicate = new AssertEqualTo(Collections.emptyList());
    ...
    public void testing_test_where_Type_is_Map() {
        Predicate<Object> predicate = new AssertEqualTo(Collections.emptyMap());
    ...
    public void testing_test_where_Type_is_Set() {
        Predicate<Object> predicate = new AssertEqualTo(Collections.emptySet());
    ...
    public void testing_test_where_Type_is_ObjectArr() {
        Predicate<Object> predicate = new AssertEqualTo(new Object[] { });
    ...
    public void testing_test_where_Type_is_booleanArr() {
        Predicate<Object> predicate = new AssertEqualTo(new boolean[] { });
    ...
    public void testing_test_where_Type_is_byteArr() {
        Predicate<Object> predicate = new AssertEqualTo(new byte[] {1, 2, 3});
    ...
    public void testing_test_where_Type_is_charArr() {
        Predicate<Object> predicate = new AssertEqualTo(new char[] {'A', 'B', 'C'});
    ...
    public void testing_test_where_Type_is_doubleArr() {
        Predicate<Object> predicate = new AssertEqualTo(new double[] { });
    ...
    public void testing_test_where_Type_is_floatArr() {
        Predicate<Object> predicate = new AssertEqualTo(new float[] { });
    ...
    public void testing_test_where_Type_is_intArr() {
        Predicate<Object> predicate = new AssertEqualTo(new int[] { });
    ...
    public void testing_test_where_Type_is_longArr() {
        Predicate<Object> predicate = new AssertEqualTo(new long[] { });
    ...
    public void testing_test_where_Type_is_shortArr() {
        Predicate<Object> predicate = new AssertEqualTo(new short[] { });
    ...
    public void calling_negate_returns_instanceof_AssertNotEqualTo() {
        Predicate<Object> predicate = new AssertEqualTo(0);
        Predicate<Object> negated = predicate.negate();
        assertEquals(AssertNotEqualTo.class, negated.getClass());
    }
}
