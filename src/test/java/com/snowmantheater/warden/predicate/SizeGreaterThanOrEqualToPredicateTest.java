...
class SizeGreaterThanOrEqualToPredicateTest {
    ...
    public void testing_test_where_Type_is_boolean() {
        ...
        predicate = new AssertSizeGreaterThanOrEqualTo(0);
        assertFalse(predicate.test(BOOL_TRUE));
        assertFalse(predicate.test(BOOL_FALSE));

        predicate = new AssertSizeGreaterThanOrEqualTo(1);
        assertFalse(predicate.test(BOOL_TRUE));
        assertFalse(predicate.test(BOOL_FALSE));
    }
    ...
    public void testing_test_where_Type_is_String() {
        ...
        predicate = new AssertSizeGreaterThanOrEqualTo(3);
        assertFalse(predicate.test(STRING_NULL));
    ...
    @Test
    @DisplayName("Calling negate() returns instanceof AssertSizeLessThan")
    public void calling_negate_returns_instanceof_AssertSizeLessThan() {
        Predicate<Object> predicate = new AssertSizeGreaterThanOrEqualTo(0);
        Predicate<Object> negated = predicate.negate();
        assertEquals(AssertSizeLessThan.class, negated.getClass());
    }
}
