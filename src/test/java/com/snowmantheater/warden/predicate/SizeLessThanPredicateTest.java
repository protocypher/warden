...
class SizeLessThanPredicateTest {
    ...
    public void testing_test_where_Type_is_String() {
        ...
        predicate = new AssertSizeLessThan(3);
        assertFalse(predicate.test(STRING_NULL));
    ...
    @Test
    @DisplayName("Calling negate() returns instanceof AssertSizeGreaterThanOrEqualTo")
    public void calling_negate_returns_instanceof_AssertSizeGreaterThanOrEqualTo() {
        Predicate<Object> predicate = new AssertSizeLessThan(0);
        Predicate<Object> negated = predicate.negate();
        assertEquals(AssertSizeGreaterThanOrEqualTo.class, negated.getClass());
    }
}
