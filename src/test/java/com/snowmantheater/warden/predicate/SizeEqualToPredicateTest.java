...
class SizeEqualToPredicateTest {
    ...
    public void testing_test_where_Type_is_String() {
        ...
        predicate = new AssertSizeEqualTo(3);
        assertFalse(predicate.test(STRING_NULL));
    ...
    public void calling_negate_returns_instanceof_AssertSizeNotEqualTo() {
        Predicate<Object> predicate = new AssertSizeEqualTo(0);
        Predicate<Object> negated = predicate.negate();
        assertEquals(AssertSizeNotEqualTo.class, negated.getClass());
    }
}
