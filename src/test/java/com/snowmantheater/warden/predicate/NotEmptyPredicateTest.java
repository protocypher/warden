...
class NotEmptyPredicateTest {
    ...
    public void testing_test_where_Type_is_boolean() {
        Predicate<Object> predicate = new AssertNotEmpty();
    ...
    @Test
    @DisplayName("Calling negate() returns instanceof AssertEmpty")
    public void calling_negate_returns_instanceof_AssertEmpty() {
        Predicate<Object> predicate = new AssertNotEmpty();
        Predicate<Object> negated = predicate.negate();
        assertEquals(AssertEmpty.class, negated.getClass());
    }
}
