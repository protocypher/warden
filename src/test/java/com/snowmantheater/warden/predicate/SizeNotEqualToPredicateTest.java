...
class SizeNotEqualToPredicateTest {
    ...
    public void testing_test_where_Type_is_String() {
        ...
        predicate = new AssertSizeNotEqualTo(3);
        assertFalse(predicate.test(STRING_NULL));
    ...
    public void calling_negate_returns_instanceof_AssertSizeEqualTo() {
        Predicate<Object> predicate = new AssertSizeNotEqualTo(0);
        Predicate<Object> negated = predicate.negate();
        assertEquals(AssertSizeEqualTo.class, negated.getClass());
    }
}
